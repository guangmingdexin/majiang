package com.guang.majiangserver.security;
...
/**
 * @ClassName SslOneWayContextFactory
    ...
    public static SSLContext getServerContext(String pkPath){
        ...
        try{
            ...
            if(pkPath!=null){
                ...
                //加载服务端证书
                // File inFile = Resources.getResourceAsFile(pkPath);
                File inFile = null;
    ...
    public static SSLContext getClientContext(String caPath){
        ...
        try{
            ...
            if (caPath != null) {
                ...
                //加载客户端证书
                // File tFile = Resources.getResourceAsFile(caPath);
               File tFile = null;
                tIN = new FileInputStream(tFile);
